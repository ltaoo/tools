...
export default defineConfig({
  ...
  shortcuts: {
    ...
    btn: "py-1 px-3 rounded border border-gray-800 text-gray-800 inline-block cursor-pointer",
    ...
    input: "py-2 px-2 border border-1 border-gray-200 rounded placeholder-gray-400",
