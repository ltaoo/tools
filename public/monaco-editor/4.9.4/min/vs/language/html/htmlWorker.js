          ...
          (t.prototype.doHover = function (i, o, n, e) {
            ...
            function p(U, H) {
              for (
                ...
                ((I = z.scan()),
                  I === S.AttributeName && (F = z.getTokenText()));
              return F;
            }
      ...
      var t = [
          ...
          function (e) {
            ...
            ((a.prototype.clone_empty = function () {
              ...
              return (
                r.set_indent(this.__indent_count, this.__alignment_count),
                r
              );
            }),
              ...
              if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
                if (f.tag_name === "body")
                  ...
                  f.tag_name === "rp" || f.tag_name === "rt"
                    ...
                    : f.tag_name === "optgroup"
                      ? (p =
                          p || this._tag_stack.try_pop("optgroup", ["select"]))
                      : f.tag_name === "option"
                        ? (p =
                            p ||
