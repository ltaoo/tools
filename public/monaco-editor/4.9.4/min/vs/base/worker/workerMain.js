...
` +
      ...
      class e {
        ...
        _remove(l) {
          if (l.prev !== N.Undefined && l.next !== N.Undefined) {
            ...
            l.prev === N.Undefined && l.next === N.Undefined
              ? ((this._first = N.Undefined), (this._last = N.Undefined))
              : l.next === N.Undefined
                ? ((this._last = this._last.prev),
                  (this._last.next = N.Undefined))
                : l.prev === N.Undefined &&
    ...
    Y(X[2], J([0, 1, 20, 25]), function (F, r, N, e) {
      ...
      ((r.AmbiguousCharacters = ce),
        ...
        (ce.cache = new N.LRUCachedFunction((R) => {
          function k(re) {
            const ue = new Map();
            for (let he = 0; he < re.length; he += 2)
              ue.set(re[he], re[he + 1]);
            return ue;
          }
          function V(re, ue) {
            const he = new Map(re);
      ...
      class p {
        ...
        _step() {
          ...
          for (let _ = 0; _ < 64; _ += 4)
            w.setUint32(_, S.getUint32(_, !1), !1);
    ...
    Y(X[13], J([0, 1, 22, 26]), function (F, r, N, e) {
      ...
      class h {
        ...
        _ComputeDiff(t, g, m, p, L) {
          ...
          return (
            L && (S = this.PrettifyChanges(S)),
            { quitEarly: w[0], changes: S }
          );
        }
          ...
          for (let P = 1; P <= i / 2 + 1; P++) {
            ...
            for (let B = d; B <= o; B += 2) {
              (B === d || (B < o && E[B - 1] >= E[B + 1])
                ...
                (s = b - (B - D) - O));
              const te = b;
              for (; b > t && s > m && this.ElementsAreEqual(b, s); )
                (b--, s--);
    ...
    Y(X[3], J([0, 1]), function (F, r) {
      ...
      class N {
        ...
        with(A = this.lineNumber, l = this.column) {
          return A === this.lineNumber && l === this.column
            ? this
            : new N(A, l);
        }
        delta(A = 0, l = 0) {
    ...
    Y(X[29], J([0, 1, 15]), function (F, r, N) {
      ...
      class e extends N.CharacterClassifier {
        constructor(y) {
          super(0);
          for (let C = 0, c = y.length; C < c; C++)
            this.set(y.charCodeAt(C), 2);
...
`
    ...
    Y(X[37], J([0, 1, 4, 36, 2, 6, 16]), function (F, r, N, e, A, l, y) {
      ...
      function c(t, g) {
        return `[${A.escapeRegExpCharacters(t.map((p) => String.fromCodePoint(p)).join(""))}]`;
      }
      class h {
        constructor(g) {
          ((this.options = g),
      ...
      ((r.win32 = {
        ...
        relative(s, a) {
          ...
          if (O !== D) {
            ...
            (u > D &&
              (s.charCodeAt(o + O) === h ? (I = O) : O === 2 && (I = 3)),
              I === -1 && (I = 0));
          }
          let q = "";
          for (O = o + I + 1; O <= i; ++O)
        ...
        (r.posix = {
          ...
          parse(s) {
            ...
            return (
              i > 0 ? (a.dir = s.slice(0, i - 1)) : f && (a.dir = "/"),
              a
            );
          },
          sep: "/",
        ...
        stop() {
          if (this._stopWatch) {
            ...
            ((this._elapsedOverall += o),
              ...
              console.info(
                `did FIRE ${this._name}: elapsed_ms: ${o.toFixed(5)}, listener: ${this._listenerCount} (elapsed_overall: ${this._elapsedOverall.toFixed(2)}, invocations: ${this._invocationCount})`,
              ),
          ...
          i.authority && i.path.length > 1 && i.scheme === "file"
            ...
            : i.path.charCodeAt(0) === 47 &&
                ((i.path.charCodeAt(1) >= 65 && i.path.charCodeAt(1) <= 90) ||
                  (i.path.charCodeAt(1) >= 97 &&
                    i.path.charCodeAt(1) <= 122)) &&
      ...
      function (F, r, N, e, A, l, y, C, c, h, v, t, g, m, p, L) {
        ...
        class w extends c.MirrorTextModel {
          ...
          getValueInRange(a) {
            ...
            return (
              i.push(this._lines[o].substring(0, a.endColumn - 1)),
              i.join(f)
            );
          }
          offsetAt(a) {
